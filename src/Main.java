...
public class Main {
    public static void main(String[] args) {
        ...
        Pharmacy pharmacy1 = new Pharmacy("Trenbolone", 10, 3, LocalDate.now());
        Pharmacy pharmacy2 = new Pharmacy("Clenbutrol", 4, 99, LocalDate.now());
        Pharmacy pharmacy3 = new Pharmacy("Winstrol", 7, 58, LocalDate.now());
    ...
    public static <Student> void printStudents(ArrayList<Student> students) {
    ...
    public static <Student> void printStudentsWithoutLowGrades(ArrayList<Student> students) {
